...
Replace this section with the supported versions for `smoketape`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `smoketape` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in smoketape.
